  ...
  return (
    <div className="debile100Admin">
      ...
      <p className="subtitle debile100Hint">
        Au lancement, {DEBILE100_SYNC_GRACE_SECONDS} secondes de synchro : les joueurs voient la
        question puis le chrono de 30 s démarre pour tout le monde en même temps (même en Wi‑Fi / 4G
        lent).
      </p>

      <section className="card">
        <h3>Configurer les 10 questions</h3>
