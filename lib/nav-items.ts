...
import { Beer, Cone, Flag, Home, Laugh, Lock, Trees, Trophy } from "lucide-react";
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/epreuves/4", label: "Parcours du Con Battant", shortLabel: "Con Battant", icon: Cone },
  { href: "/epreuves/5", label: "100% Débile", shortLabel: "100%", icon: Laugh },
